  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="max-w-lg">
        <AlertDialogHeader>
          <AlertDialogTitle>Adicionar Gastos</AlertDialogTitle>
          <AlertDialogDescription>
            Adicione seus gastos e acompanhe o total acumulado.
          </AlertDialogDescription>
        </AlertDialogHeader>
        ...
        <ScrollArea className="h-80 py-2">
          <div className="space-y-4">
            {gastos.map(gasto => (
              <div key={gasto.id} className="flex gap-2 items-end bg-muted p-3 rounded-md border">
